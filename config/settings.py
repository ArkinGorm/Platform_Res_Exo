...
DATABASES = {
    'default': {
        ...
        'CONN_MAX_AGE': 60,  # Django 5.2 supporte les connexions persistantes
        'OPTIONS': {
            'connect_timeout': 10,
        }
    }
...
USE_I18N = True
USE_TZ = True
USE_L10N = True  # Django 5.2 active par défaut
...
REST_FRAMEWORK = {
    ...
    'DATETIME_FORMAT': '%Y-%m-%d %H:%M:%S',  # Django 5.2 compatible
}
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,  # Django 5.2 recommande True
    'BLACKLIST_AFTER_ROTATION': True,
    'UPDATE_LAST_LOGIN': True,  # Django 5.2 nouvelle option
    'ALGORITHM': 'HS256',
...
# Security (recommandations Django 5.2)
if not DEBUG:
