...
const ExerciseDetail = () => {
  ...
  // Si le chargement fini et que l'exercice est introuvable (erreur potentiel dans l'API ou mauvais ID)
  if (!exercise) {
    return (<div className="Error-container">
      <h2> Exercice introuvable</h2>
        <p> Nous rencontrons actuellement des difficultés en ce qui concerne le chargement des exercices! Veuillez revenir plus tard</p>
